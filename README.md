# quarkus-backend-template

This is a template project of our quarkus backend services.
...
You can then execute your native executable with: `./target/backend-quarkus-template-1.0-runner`
